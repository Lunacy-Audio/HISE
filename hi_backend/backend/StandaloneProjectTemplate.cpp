...
"  </MAINGROUP>\r\n"
"  <EXPORTFORMATS>\r\n"
"    <%VS_VERSION% targetFolder=\"Builds/%TARGET_FOLDER%/\" IPP1ALibrary=\"%IPP_1A%\"  %ICON_FILE% extraDefs=\"%EXTRA_DEFINES_WIN%\"  extraLinkerFlags=\"%UAC_LEVEL%\" extraCompilerFlags=\"/bigobj %MSVC_WARNINGS%\">\r\n"
"      <CONFIGURATIONS>\r\n"
...
"        <CONFIGURATION name=\"Release\" isDebug=\"0\" optimisation=\"3\" targetName=\"%NAME%\" headerPath=\"%IPP_HEADER%;%FAUST_HEADER_PATH%\" libraryPath=\"%IPP_LIBRARY%\"/>\r\n"
"      </CONFIGURATIONS>\r\n"
"      <MODULEPATHS>\r\n"
...
"               JUCE_ASIO=\"%USE_ASIO%\" JUCE_JACK=\"%USE_JACK%\" USE_SPLASH_SCREEN=\"%USE_SPLASH_SCREEN%\" HI_ENABLE_LEGACY_CPU_SUPPORT=\"%LEGACY_CPU_SUPPORT%\" HISE_INCLUDE_RLOTTIE=\"enabled\" HISE_INCLUDE_FAUST=\"%HISE_INCLUDE_FAUST%\" HLAC_MEASURE_DECODING_PERFORMANCE=\"disabled\" HLAC_DEBUG_LOG=\"disabled\" HLAC_INCLUDE_TEST_SUITE=\"disabled\" STANDALONE_STREAMING=\"disabled\""
